    ...
    >
      ...
      <div className="relative">
        ...
        <div className="mt-5 border-t border-border pt-4">
          <div className="relative">
            {/* Work → Earn → Bridge → Settle, walked in colour: emerald for
                the three steps that are mechanism, bright teal for the one
                that is outcome. */}
            <div
              className="absolute left-[12.5%] right-[12.5%] top-[5px] h-0.5 bg-gradient-to-r from-primary/60 via-primary/50 to-success/70"
              aria-hidden
            />
                  ...
                  <div key={label} className="flex flex-col items-center gap-1.5">
                    ...
                    <span
                      className={cn(
                        ...
                        last ? "font-semibold text-success" : "text-muted-foreground",
                      )}
                    >
                      {label}
                    </span>
