...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. Employers, HR and payroll teams can register their interest to help shape the pilot and be among the first to offer PayBridge. Registering is the first step only; a pilot follows qualification, a discovery meeting and a payroll assessment.",
  },
  {
  ...
  },
  {
    ...
    a: "Capital providers and financial institutions can support monitored workforce-finance programmes built around verified data, clear limits, settlement controls and transparent reporting. Registering your interest is an expression of interest only — it is not an offer, solicitation or investment application, and any future opportunity would be subject to legal, regulatory, due-diligence and suitability requirements.",
  },
  {
    q: "Is PayBridge live yet?",
    a: "PayBridge is currently being developed. Registering your interest gives you pilot updates and launch announcements. Register interest now; verification only begins when activation does.",
  },
  {
